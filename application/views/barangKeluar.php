	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-xl-12">
				<div class="card-box">
					<center>
						<button id="btnScan" data-toggle="modal" data-target="#modalScan" class="btn btn-success btn- mb-4">SCAN BARANG KELUAR</button>
					</center>
					<table id="dataTable" class="table table-hover">
						...
						<tbody>
                            ...
                            <tr>
                                <td><?php echo $bk['material_no'] ?></td>
                                <td><?php echo $bk['job_no'] ?></td>
                                <td><?php echo $bk['type'] ?></td>
                                <td><?php echo $bk['part_no'] ?></td>
                                <td><?php echo $bk['stock_out'] ?></td>
...
<script>
	...
	$('#formStock').on('submit', function(e){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo site_url('home/delete_stock');?>",
